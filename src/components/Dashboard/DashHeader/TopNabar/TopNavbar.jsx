...
const TopNavbar = ({ openSidebar }) => {
  ...
  return (
    <header className="dark:bg-black py-4 w-full z-[9999] flex flex-row-reverse lg:flex-row items-center justify-between px-4">
      <h1 className="text-lg font-bold theme-text md:hidden lg:block">
        Dashboard
      </h1>
